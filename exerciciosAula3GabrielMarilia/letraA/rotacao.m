 %O código deve rotacionar uma imagem no sentido antihorário,
 %para qualquer ângulo theta. Escolha um método de interpolação
 %de pixels (nearest, bilinear ou bicubic), justificando sua escolha.
 %Obs: não é válida a utilização da função imrotate e/ou rot do matlab;
